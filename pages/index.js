...
const Home = () => {
  ...
  const innerBoxStyles = {
    ...
    borderRadius: '20px',
    // background:
    //   'linear-gradient(30deg, rgba(34,193,195,1) 0%, rgba(253,187,45,1) 100%)'
    // Background from immage dynamic based on usercoloemodevalue
    textColor: currentColor,
    backgroundSize: 'cover'
    // Shadow
    // boxShadow: '0 0 200px 0 rgba(0, 0, 0, 0.5)'
  }
          ...
          <Box flex="7">
            ...
            >
              <Heading fontWeight="600" fontSize="50px">
                Hey, I am Takuya Matsuyama, an indie app developer based in
                Japan!
              </Heading>

              <Text mt={14}>
                I have a knack for all things launching products, from planning
                and designing all the way to solving real-life problems with
                code. When not online, he loves hanging out with his camera.
              </Text>
              ...
              <Box mt="auto" justifyContent="space-between" marginLeft={0}>
                <Box
                  ...
                  // flexDirection="row"
                  alignItems="center"
                  // Give horizontal spacing to the elements
                  justifyContent="space-between"
                  // Give vertical spacing to the elements
                  spacing={40}
                >
                  <Box>
                    <Button
